...
public class ApplicationDbContext : IdentityDbContext<AspNetUser, AspNetRole, string>, IApplicationDbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-49L2TDH\\MAY1;Database=FitLogDatabase;User ID=sa;Password=123456;Trust Server Certificate=True;Trusted_Connection=True;MultipleActiveResultSets=true");
