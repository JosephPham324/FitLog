...
//          <FormLabel component="legend" className={classes.boldText}>1. What is your experience level? <span className={classes.redAsterisk}>(*)</span>
//          </FormLabel>
//          <RadioGroup
//            value={experience}
...
//        <FormControl component="fieldset" fullWidth className={classes.formControl}>
//          <FormLabel component="legend" className={classes.boldText}>2. What type of gym do you usually train in? <span className={classes.redAsterisk}>(*)</span>
//          </FormLabel>
//          <RadioGroup
//            value={gymType}
...
//        <FormControl component="fieldset" fullWidth className={classes.formControl}>
//          <FormLabel component="legend" className={classes.boldText}>3. What is your primary fitness goal? <span className={classes.redAsterisk}>(*)</span>
//          </FormLabel>
//          <RadioGroup
//            value={fitnessGoal}
...
//        <FormControl component="fieldset" fullWidth className={classes.formControl}>
//          <FormLabel component="legend" className={classes.boldText}>4. Which muscle groups do you prioritize? <span className={classes.redAsterisk}>(*)</span>
//          </FormLabel>
...
//          <FormLabel component="legend" className={classes.boldText}>5. How many days per week do you train? <span className={classes.redAsterisk}>(*)</span>
//          </FormLabel>
//          <Select
//            value={daysPerWeek}
...
//          <FormLabel component="legend" className={classes.boldText}>6. What is your birthdate? <span className={classes.redAsterisk}>(*)</span>
//          </FormLabel>
//          <TextField
//            type="text"
//            value={age}
