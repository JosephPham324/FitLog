...
//    if (age && isAfter(selectedDate, currentDate)) {
//      newErrors.ageInvalid = true;
//    } else if (age && differenceInYears(currentDate, selectedDate) < 14) {
//      newErrors.ageUnder14 = true;
//    }
...
//            value={age}
//            onChange={(e) => setAge(e.target.value)}
//            error={errors.age || errors.ageInvalid || errors.ageUnder14}
//            InputLabelProps={{
//              shrink: true,
//            }}
//          />
...
//          {errors.ageUnder14 && (
//            <Typography color="error">
//              You must be of age to fill out the Survey.
//            </Typography>
//          )}
//        </FormControl>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <FormControl component="fieldset" fullWidth className={classes.textFieldControl}>
          ...
          <TextField
            ...
            inputProps={{
              max: today, // Ngăn người dùng chọn ngày trong tương lai
            }}
          />
          {errors.age && (
            <Typography color="error">
          ...
          {errors.ageUnder14 && (
            <Typography color="error">
              You must be of age to fill out the Survey.   Survey age must be over 14
            </Typography>
          )}
        </FormControl>
