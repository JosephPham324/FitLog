...
//      const response = await axiosInstance.post("https://localhost:44447/api/Equipments", newEquipment, {
//        headers: {
...
//    try {
//      await axiosInstance.put(`/Equipments/${selectedEquipment.id}`, {
...
//              </td>
//              <td>
//                <button className="edit-buttone" onClick={() => handleOpenUpdate(equipment)}>Edit</button>
//              </td>
//            </tr>
//          ))}
//        </tbody>
