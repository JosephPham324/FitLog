...
//    { id: 1, name: 'Equipment 1', details: 'Detail for Equipment 1', imageUrl: 'https://example.com/image1.jpg' },
...
//  const validateInput = (name, imageUrl) => {
...
//    }
//    if (imageUrl.trim() === '') {
//      setError('Image URL cannot be left blank');
//      return false;
//    }
...
//  const handleCreate = () => {
//    if (!validateInput(newEquipmentName, newEquipmentImageUrl)) {
//      return;
//    }
//    const newEquipment = {
...
//  const handleUpdate = () => {
//    if (!validateInput(selectedEquipment.name, selectedEquipment.imageUrl)) {
...
//      <h2 className="equipments-title">Equipments</h2>
...
//            type="text"
//            fullWidth
//            value={newEquipmentImageUrl}
//            onChange={(e) => setNewEquipmentImageUrl(e.target.value)}
//          />
//        </DialogContent>
//        <DialogActions>
...
//            type="text"
//            fullWidth
//            value={selectedEquipment ? selectedEquipment.imageUrl : ''}
//            onChange={(e) => setSelectedEquipment({ ...selectedEquipment, imageUrl: e.target.value })}
//          />
//        </DialogContent>
//        <DialogActions>
...
//              <p><strong>Image URL:</strong> {selectedEquipment ? selectedEquipment.imageUrl : ''}</p>
//            </div>
//          </DialogContentText>
//        </DialogContent>
//        <DialogActions>
...
const EquipmentsList = () => {
  ...
  return (
    <div className="equipments-container">
      ...
      <span className="gradient-text"> Equipments</span></h2>
    ...
    <DialogContent>
      <DialogContentText>
        <div>
          ...
          <p><strong>Equipment Name:</strong> {selectedEquipment ? selectedEquipment.name : ''}</p>
          <p><strong>Image URL:</strong> {selectedEquipment ? selectedEquipment.imageUrl : ''}</p>
          {selectedEquipment && <img src={selectedEquipment.imageUrl} alt={selectedEquipment.name} style={{ width: '100px', height: '100px' }} />}
        </div>
      </DialogContentText>
    </DialogContent>
    <DialogActions>
